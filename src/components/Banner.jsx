...
const Banner = () => {
  return (
    <div className='max-w-[1920px] w-screen mt-[60px] md:mt-[143px] min-h-[700px] md:min-h-[900px] 2xl:min-h-fit flex items-center justify-center mx-auto bg-banner-gradient overflow-hidden'>
      <img
        src={ImgBanner}
        alt='banner image'
        className='max-h-full w-1/2 2xl:block hidden'
      />
      <div className='md:pl-[100px] px-[25px] pt-3 md:px[10px] flex-1 w-full h-full mt-7 md:my-auto overflow-hidden'>
        ...
        <p className='my-[40px] font-medium text-[26px] md:text-[32px] tracking-tighter lg:w-full text-[#231300]'>
