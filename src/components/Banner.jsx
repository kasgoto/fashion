...
const Banner = () => {
  return (
    <div className='max-w-[1920px] w-screen mt-[60px] md:mt-[143px] min-h-[700px] md:min-h-[900px] 2xl:min-h-fit flex items-center justify-center mx-auto bg-banner-gradient'>
      <img
        src={ImgBanner}
        alt='banner image'
